...
## 0.2.0-alpha — 正式交付政策與視覺重製開始

### 部分完成

- 垂直切片改為純內部開發基礎；完整第一版達標前不再要求使用者測試半成品。
- 遊戲畫布開始改為全視口，首批四個設備由六角形占位改為不同職業設備造型，AI 角色提高辨識度。

### 尚未完成

- 響應式鏡頭、HUD 分離、11 種設備完整美術、桌機／iPhone 截圖驗證與完整第一版功能仍在開發中。
